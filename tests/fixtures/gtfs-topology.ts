...
export const topologyFixture = {
  ...
  trips: [
    { route_id: '2_13', trip_id: 'outbound-one', direction_id: '0', service_id: 'weekday' },
    { route_id: '2_13', trip_id: 'outbound-two', direction_id: '0', service_id: 'weekday' },
    { route_id: '2_13', trip_id: 'inbound', direction_id: '1', service_id: 'weekday' },
    { route_id: '1_204', trip_id: 'other-agency', direction_id: '0', service_id: 'other' },
  ],
  stopTimes: [
    {
      trip_id: 'outbound-one',
      stop_id: 'cadiz',
      stop_sequence: '1',
    ...
    { trip_id: 'inbound', stop_id: 'puerto', stop_sequence: '1', arrival_time: '10:00:00', departure_time: '10:00:00' },
    { trip_id: 'inbound', stop_id: 'cadiz', stop_sequence: '2', arrival_time: '10:45:00', departure_time: '10:45:00' },
    {
      trip_id: 'other-agency',
      stop_id: 'sevilla',
      stop_sequence: '1',
      arrival_time: '08:00:00',
      departure_time: '08:00:00',
  ...
  calendarDates: [{ service_id: 'weekday', date: '20260925', exception_type: '2' }],
} as const;
