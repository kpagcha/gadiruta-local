...
import { deriveLocationCoordinates } from '../../../../scripts/ctan/research/derive-location-coordinates.ts';
import type { LocationDirectory } from '../../../../scripts/ctan/location-directory.ts';
